...
/*
 * It creates a table that shows the current version of the module, date, time and the unix time,
 * also information regarding the begining and ending time of the module.
 */

$table = new html_table ();
$table->data [] = array (
		get_string ( 'version', 'local_reservasalas' ),
		'2013050400' 
);
$table->data [] = array (
		get_string ( 'datediagnostic', 'local_reservasalas' ),
		$ahoradate 
);
$table->data [] = array (
		get_string ( 'hour', 'local_reservasalas' ),
		$ahorahora 
);
$table->data [] = array (
		get_string ( 'unixtime', 'local_reservasalas' ),
		$ahoratime 
);
