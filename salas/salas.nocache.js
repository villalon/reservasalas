function salas(){
  ...
  salas.__installRunAsyncCode = function(){
  }
  ;
  ...
  ;
  salas.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  salas.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  salas.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules['salas'].bindings;
    activeModules['salas'].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[salas.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (salas.__errFn) {
        script.onerror = function(){
          salas.__errFn('salas', new Error('Failed to load ' + code_0));
        }
        ;
      }
  ...
  function getCompiledCodeFilename(){
    ...
    var strongName;
    try {
      unflattenKeylistIntoAnswers(['ie9'], '587DFF923AADF38FEFF2A8F8D93B66C9');
      unflattenKeylistIntoAnswers(['gecko1_8'], '6D9958CFD3B332E6BAC1F1B10C4122E2');
      unflattenKeylistIntoAnswers(['safari'], '7DE28D0BB6AB66B195806EAA8E73352B');
      unflattenKeylistIntoAnswers(['ie10'], 'C7C23B33D9932D92862BA5763233C50C');
      unflattenKeylistIntoAnswers(['ie8'], 'F4D9FE4E515324A709AE39EB45C5486D');
